...
private final class URLProtocolAsyncResultBox<Value> {
...
final class AppProxyURLProtocol: URLProtocol {
    ...
    override func startLoading() {
        ...
        thread.name = "work.picav.app-proxy.url-protocol"
        workerThread = thread
        thread.start()
    }
    ...
    private static let preservedBodyProperty =
        "work.picav.app-proxy.preserved-body"
