...
private protocol AppVMessHash: AnyObject {
    func update(_ data: Data)
    func digest() -> Data
    func copyHash() -> AppVMessHash
}

private final class AppVMessSHA256: AppVMessHash {
    func update(_ data: Data) {
        buffer.append(data)
    }
...
private final class AppVMessRecursiveHMAC: AppVMessHash {
    static func make(
        key: Data,
        base: AppVMessHash
