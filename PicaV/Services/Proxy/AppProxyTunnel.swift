...
protocol AppProxyByteTunnel: AnyObject {
    func send(_ data: Data) async throws
    func receive() async throws -> Data
    func close()
}

private final class ConnectionContinuationState<Value: Sendable>: @unchecked Sendable {
...
extension NWConnection {
    ...
    private static let appProxyQueue = DispatchQueue(
        label: "work.picav.app-proxy.connection",
        qos: .userInitiated,
        attributes: .concurrent
    )
}

final class NWConnectionAppProxyTunnel:
